 ...
 * @route '/livewire-c2dbdb34/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-c2dbdb34/upload-file',
 ...
 * @route '/livewire-c2dbdb34/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-c2dbdb34/preview-file/{filename}',
