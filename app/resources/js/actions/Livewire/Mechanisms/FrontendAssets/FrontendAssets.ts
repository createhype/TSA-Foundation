 ...
 * @route '/livewire-c2dbdb34/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-c2dbdb34/livewire.js',
 ...
 * @route '/livewire-c2dbdb34/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-c2dbdb34/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-c2dbdb34/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-c2dbdb34/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
